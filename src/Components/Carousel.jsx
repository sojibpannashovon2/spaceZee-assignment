...
const Carousel = () => {
  ...
  return (
    <div className="relative  mx-auto h-[640px] w-[1280px] my-8 px-12 ">
      {/* Carousel Images */}
      <div className="overflow-hidden relative h-[640px] w-full ">
        {images.map((image, index) => (
          ...
          >
            <img
              src={image}
              alt={`Slide ${index + 1}`}
              className="w-full object-cover h-[640px] rounded-xl"
            />
          </div>
        ))}
      </div>
